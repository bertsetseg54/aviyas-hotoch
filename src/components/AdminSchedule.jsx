...
export default function AdminSchedule() {
  ...
  const [status, setStatus] = useState(null); // Амжилттай эсвэл алдаа харуулах
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setLoading(false); 
      setTimeout(() => setStatus(null), 3000); // 3 сек дараа мэдэгдэл арилна
    }
  };
